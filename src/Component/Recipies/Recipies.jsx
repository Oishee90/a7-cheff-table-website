...
const Recipies = ({recipe,  handleCart}) => {
  ...
  <div className="mt-4 ">
    ...
    <div className="mt-4 text-left font-lexend ">
     ...
     <button onClick={(e)=> handleCart(recipe)} className="btn text-xl font-lexend  btn-success hover:bg-green-700 btn-xs sm:btn-sm md:btn-md lg:btn-lg rounded-full">Wait to Cook</button>
     </div>
    </div>
    </div>
